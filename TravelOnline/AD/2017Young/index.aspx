...
<meta name="description" content="2017全国青少年宫体育舞蹈比赛">
<title>2017全国青少年宫体育舞蹈比赛</title>
...
<body>
   ...
   <div class="headtop">
      <div class="topposition">
         <a href="http://www.scyts.com/" class="logo fl" target="_blank"><img src="images/logo5A.jpg" alt="上海青旅5A旅行社" /></a>
         <span class="telphone fl">
            <img src="images/tel.gif" alt="4006-777-666" />
         </span>
         <ul class="topNav fl">
    ...
    <div id="content">
        ...
        <p align="center"><strong><span>2017全国青少年宫体育舞蹈比赛</span></strong></p>
			...
			<p>三、比赛地点：上海市上海大学体育馆（宝山区上大路99号）</p>
			<p>四、参赛单位：</p>
			...
			<p>十二、本规程的解释权属主办单位，未尽事宜另行通知。</p>
            <p>报名方式：下载附件中的"2017全国青少年宫体育舞蹈比赛报名表"，并填写完成（打*号的为必填项），在下方完成上传。</p>
            <p>注：组别、项目选择可参考附件中的"2017全国青少年宫体育舞蹈比赛组别、项目"</p>
            ...
            <%if(userType!=null&&userType=="upload"){ %>
                <a href="<%= uploadPath%>">已上传报名表，点击查看</a>
            <%} %>
			<p>附件：</p>
			<p>1、<a class="downLoadFile" href="2017全国青少年宫体育舞蹈比赛报名表.xlsx">《2017全国青少年宫体育舞蹈比赛报名表》点击下载</a></p>
			<p>2、<a class="downLoadFile" href="2017全国青少年宫体育舞蹈比赛组别、项目.doc">《2017全国青少年宫体育舞蹈比赛组别、项目》点击下载</a></p>
   ...
   <div class="main-im">
      ...
      <div class="im_main" id="im_main">
         ...
         <a href="<A href="tencent://message/?uin=593705862&amp;Site=博客园&amp;Menu=yes" target="_blank" class="im-qq qq-a" title="在线QQ客服">
         ...
         <div class="im-tel">
            <div>咨询热线</div>
            <div class="tel-num">4006-777-666</div>
            <div>服务时间</div>
            <div class="tel-num">08:30-21:30</div>
         </div>

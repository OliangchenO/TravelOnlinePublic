<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageQuestion.aspx.cs" Inherits="TravelOnline.Management.ManageQuestion" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>出境及国内旅游线路管理</SPAN></DIV>
 ...
 <DIV class="m select">
    ...
    <DIV class=mt>
        ...
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-cancel" onclick="DoIt('CancelRecommend')">重置</a>
        ...
        <ContentTemplate>
            <DIV id="explain" class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
                    ...
                    OnDataBound="GridView_DataBound" GridLines="Vertical" SortExpression="id" SortDirection="ASC">
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="id" HeaderText="抽奖码" SortExpression="id">
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        ...
        function DoIt(DoFlag) {
            ...
            var url = "AjaxService.aspx?action=TruncateQuestion&r=" + Math.random();

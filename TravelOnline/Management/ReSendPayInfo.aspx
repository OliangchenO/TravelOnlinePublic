<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReSendPayInfo.aspx.cs" Inherits="TravelOnline.Management.ReSendPayInfo" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>出境及国内旅游线路管理</SPAN></DIV>
 ...
 <DIV class="m select">
    ...
    <DIV class=mt>
        <H1></H1><STRONG>问答管理</STRONG>
    </DIV>
        <div class="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-reload" onclick="javascript:$('#GridView_Refresh_Button').click();">查询</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-cancel" onclick="DoIt('CancelRecommend')">重发</a>
        ...
        <ContentTemplate>
            <DIV id="explain" class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
                    ...
                    OnDataBound="GridView_DataBound" GridLines="Vertical" SortExpression="PayTime" SortDirection="ASC">
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="OrderNums" HeaderText="订单数量" SortExpression="OrderNums">
		                    <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="OrderMobile" HeaderText="手机号" SortExpression="OrderMobile">
		                    <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="PayTime" HeaderText="支付日期" SortExpression="PayTime">
		                    <HeaderStyle Width="10%" />
                        </asp:BoundField>
		            </Columns>
                    <PagerTemplate>
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        ...
        function DoIt(DoFlag) {
            ...
            var url = "AjaxService.aspx?action=ResendPayInfo&r=" + Math.random();

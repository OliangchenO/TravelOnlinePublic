    ...
    public class ErpUtil
    {
        public static string getToken()
        {
            ...
            if (infos == "")
            {
                ...
                SaveLogUtils.SaveInfoToLog("getToken: " + requestxml, "RequestErpInfoLog.txt");
                XmlSerializer ser = new XmlSerializer();

                IRestResponse response = client.Execute(request);
                XmlDocument XmlDoc = new XmlDocument();
                XmlDoc.LoadXml(response.Content);
                SaveLogUtils.SaveInfoToLog("getToken: " + response.Content, "ResponseErpInfoLog.txt");
        ...
        public static string savePayInfo(string rpMode, string orderNo, string amount, string summary, string checkNo, string bankaccount, string dsenddate)
        {
            ...
            SaveLogUtils.SaveInfoToLog("savePayInfo: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("savePayInfo: " + response.Content, "ResponseErpInfoLog.txt");
        ...
        public static string getTeamInfo(string startDate, string endDate, string MislineId)
        {
            ...
            request.AddHeader("Accept", "application/xml");
            request.AddParameter("application/xml", Stings, ParameterType.RequestBody);
            SaveLogUtils.SaveInfoToLog("getTeamInfo: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("getTeamInfo: " + response.Content, "ResponseErpInfoLog.txt");
        ...
        public static PlanPrices getPriceInfo(string MislineId, string startDate)
        {
            ...
            request.AddHeader("Accept", "application/xml");
            request.AddParameter("application/xml", Stings, ParameterType.RequestBody);
            SaveLogUtils.SaveInfoToLog("getPriceInfo: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("getPriceInfo: " + response.Content, "ResponseErpInfoLog.txt");
        ...
        public static string cancelOrder(string orderNo, string reason)
        {
            ...
            request.AddHeader("Accept", "application/xml");
            request.AddParameter("application/xml", Stings, ParameterType.RequestBody);
            SaveLogUtils.SaveInfoToLog("cancelOrder: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("cancelOrder: " + response.Content, "ResponseErpInfoLog.txt");
            XmlNode o = XmlDoc.SelectSingleNode("//o");
            string status = o.SelectSingleNode("status").InnerText;
            if (status.Equals("1"))
            {
        ...
        public static string getWechatTeamInfo(string startDate, string endDate, string MislineId)
        {
            ...
            request.AddHeader("Accept", "application/xml");
            request.AddParameter("application/xml", Stings, ParameterType.RequestBody);
            SaveLogUtils.SaveInfoToLog("getWechatTeamInfo: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("getWechatTeamInfo: " + response.Content, "ResponseErpInfoLog.txt");
            XmlNodeList e = XmlDoc.SelectNodes("//e");
            StringBuilder Teams = new StringBuilder();
            Teams.Append("var json = [");
            string defaultStartDate = startDate;
        ...
        public static string UpdateOrderAccount(string iweboutid, string nprice)
        {
            ...
            StringBuilder Stings = new StringBuilder();
            Stings.Append("<?xml version=\"1.0\" encoding=\"utf-8\"?>");
            Stings.Append("<JJTourcrsUpdateOrderAccountRQ>");
            Stings.Append("<Header>");
            Stings.Append(string.Format("<Token>{0}</Token>", ErpUtil.getToken()));
            Stings.Append(string.Format("<DateTime>{0}</DateTime>", string.Format("{0:yyyy-MM-dd HH:mm:ss}", DateTime.Now)));
            Stings.Append("</Header>");
            ...
            Stings.Append("</orderAccount></OrderAccountUpdate></Body></JJTourcrsUpdateOrderAccountRQ>");
            IRestRequest request = new RestRequest("jjapi-ws/api/JJTourcrsUpdateOrderAccount", Method.POST);
            request.RequestFormat = DataFormat.Xml;
            request.AddHeader("Accept", "application/xml");
            request.AddParameter("application/xml", Stings, ParameterType.RequestBody);
            SaveLogUtils.SaveInfoToLog("UpdateOrderAccount: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("UpdateOrderAccount: " + response.Content, "ResponseErpInfoLog.txt");
            XmlNode o = XmlDoc.SelectSingleNode("//o");
            string status = o.SelectSingleNode("status").InnerText;
            if (status.Equals("1"))
            {
        ...
        public static string SubGroup(string uteamid, string groupGuestid, string groupTeamNo)
        {
            RestClient client = new RestClient(ConfigurationManager.AppSettings["JINWebServiceUrl"].ToString());
            StringBuilder Stings = new StringBuilder();
            Stings.Append("<?xml version=\"1.0\" encoding=\"utf-8\"?>");
            ...
            Stings.Append(string.Format("<DateTime>{0}</DateTime>", string.Format("{0:yyyy-MM-dd HH:mm:ss}", DateTime.Now)));
            Stings.Append("</Header>");
            Stings.Append("<Body><SubGroupQuery><subGroup>");
            Stings.Append(string.Format("<uteamid>{0}</uteamid>", uteamid.Trim()));
            ...
            Stings.Append("</subGroup></SubGroupQuery></Body></JJTourcrsSubGroupRQ>");
            IRestRequest request = new RestRequest("jjapi-ws/api/JJTourcrsSubGroup", Method.POST);
            request.RequestFormat = DataFormat.Xml;
            request.AddHeader("Accept", "application/xml");
            request.AddParameter("application/xml", Stings, ParameterType.RequestBody);
            SaveLogUtils.SaveInfoToLog("SubGroup: " + Stings, "RequestErpInfoLog.txt");
            IRestResponse response = client.Execute(request);
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(response.Content);
            SaveLogUtils.SaveInfoToLog("SubGroup: " + response.Content, "ResponseErpInfoLog.txt");
            XmlNode o = XmlDoc.SelectSingleNode("//o");
            string status = o.SelectSingleNode("status").InnerText;
            if (status.Equals("1"))
            {

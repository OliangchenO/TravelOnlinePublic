<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderShare.aspx.cs" Inherits="TravelOnline.WeChat.Share.OrderShare" %>
<!DOCTYPE html>
   ...
   <div class="sub_view" id="first_view"> 
    <div class="product_wrap"> 
     ...
     <div class="price_box" style="font-size: 16px;"> 
      <i class="fa fa-cny"></i> 
      <span class="allprice price"><%= LinePrice %></span>（分享立减<span id="shareDiscount">99</span>元/本）
     </div>
    </div> 

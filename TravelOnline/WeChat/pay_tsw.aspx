<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pay_tsw.aspx.cs" Inherits="TravelOnline.WeChat.pay_tws" %>
<!DOCTYPE html>
        ...
        <div class="recommend_wrap">
            <div class="recommend_detail">
                <div class="recommend_txt">
                    ...
                    <li class="<%=hide %>"><div class=tname>预订票数：</div><div class=tinfo><%=Nums%>人 <%=NumsInfo%></div></li>
